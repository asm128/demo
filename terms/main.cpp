...
::gpk::error_t										gpk_cgi_generate_output			(::gpk::SCGIRuntimeValues & runtimeValues, ::gpk::array_pod<char_t> & output)	{
	...
	if(lang == ::gpk::view_const_string{"es"}) {
		...
		output.append(::gpk::view_const_string{ "\n<br/>Este sitio web, sin conexión contractual con Wikipedia otra que su licencia de usuario y sus propias delcaraciones de derechos de autor, anima explícitamente a sus usuarios a leer las fuentes originales debido a que la utilización de las mismas apunta a proveer al usuario con fuentes de información imparcial y detallada, separada de la publicidad y promoción paga provista en otras secciones del sitio web.</p>"	});
